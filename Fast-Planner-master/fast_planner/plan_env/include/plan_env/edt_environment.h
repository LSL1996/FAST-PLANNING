...
private:
  ...
  double distToBox(int idx, const Eigen::Vector3d& pos, const double& time);  /// 到障碍物的距离
  double minDistToAllBox(const Eigen::Vector3d& pos, const double& time);  /// 到所有障碍物最小的距离
